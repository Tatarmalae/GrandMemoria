...
class Utilities
{
     ...
     * @param bool $bool
     */
    public static function DB($ext, bool $bool = false)
    {
        echo '<pre>';
        if ($bool) {
            var_dump($ext);
     ...
     * @param bool $bool
     */
    public static function DH($ext, bool $bool = false)
    {
        if ($_REQUEST['D'] == 'Y') {
            echo '<pre>';
            if ($bool) {
     ...
     * @return array
     */
    public static function getMultilevelArray($array): array
    {
        $maxLevel = 0;
        $minLevel = 9999;
     ...
     * @return array
     */
    public static function arrayReverseRecursive($arr): array
    {
     ...
     * @return string
     */
    public static function getFormatDateActions($dateFrom, $dateTo): string
    {
     ...
     * @return string
     */
    public static function hex2rgb($hex, $opacity): string
    {
        $hex = str_replace("#", "", $hex);
        if (strlen($hex) == 3) {
     ...
     * @return string
     */
    public static function formatBytes($bytes, $decimals = 0): string
    {
        if ($bytes >= 1073741824) {
