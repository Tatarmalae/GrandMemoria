            ...
            <div class="swiper-container base-slider" data-count="2">
                <div class="slider-wrap swiper-wrapper">
                    <?php foreach ($arResult['ITEMS'] as $item): ?>
                        <?php $thumb = CFile::ResizeImageGet($item['PREVIEW_PICTURE'], ['width' => 1280, 'height' => 720], BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true, []); ?>
                        <?php if ($item['PROPERTIES']['RUTUBE']['VALUE']): ?>
                            <div class="slider-slide swiper-slide">
                                <div class="video-item item">
                                    <div class="video">
                                        <a class="video-play object-fit" href="#"
                                           data-options="{&quot;src&quot;:&quot;<?= $item['PROPERTIES']['RUTUBE']['VALUE'] ?>&quot;}"
                        ...
                        <?php elseif (!empty($item['PROPERTIES']['YOUTUBE']['VALUE'])): ?>
                            <?php
                            /*
                            ...
                            */
                            $item['PROPERTIES']['YOUTUBE']['PREVIEW_IMAGE'] = $thumb['src'];
                            ?>
                            <div class="slider-slide swiper-slide">
                                <div class="video-item item">
                                    <div class="video">
                                        <a class="video-play object-fit" href="#"
                                           data-options="{&quot;src&quot;:&quot;https://www.youtube.com/watch?v=<?= $item['PROPERTIES']['YOUTUBE']['VALUE'] ?>&quot;}"
                                           data-fancybox="gallery">
                                            <img class="lazy anim"
                                                 data-src="<?= $item['PROPERTIES']['YOUTUBE']['PREVIEW_IMAGE'] ?>"
                                                 alt="<?= $item['NAME'] ?>" src="">
                                            <span class="video-play__icon">
                                            <svg width="90" height="54" viewBox="0 0 120 84" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
