...
class FFMpeg extends AbstractConverter
{
    ...
    {
        return ['alpha-quality', 'auto-filter', 'low-memory', 'metadata', 'near-lossless', 'sharp-yuv', 'size-in-percentage'];
    }
    /**
    ...
    public function checkOperationality()
    {
        ...
        if (!$this->isInstalled()) {
            throw new SystemRequirementsNotMetException('ffmpeg is not installed (cannot execute: "' . $this->getPath() . '")');
        }
