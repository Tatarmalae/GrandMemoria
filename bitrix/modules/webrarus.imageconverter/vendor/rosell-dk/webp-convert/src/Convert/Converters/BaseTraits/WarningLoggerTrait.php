...
trait WarningLoggerTrait
{
    ...
    public function warningHandler($errno, $errstr, $errfile, $errline, $errcontext = null)
    {
        ...
        */
        ...
        $errorTypes = [\E_WARNING => "Warning", \E_NOTICE => "Notice", \E_STRICT => "Strict Notice", \E_DEPRECATED => "Deprecated", \E_USER_DEPRECATED => "User Deprecated"];
        ...
        if (!\is_null($this->previousErrorHandler)) {
            ...
            if (\is_array($this->previousErrorHandler) && isset($this->previousErrorHandler[0]) && $this->previousErrorHandler[0] == $this) {
                return \false;
            } else {
    ...
    protected function activateWarningLogger()
    {
        ...
        $this->previousErrorHandler = \set_error_handler(array($this, "warningHandler"), \E_WARNING | \E_USER_WARNING | \E_NOTICE | \E_USER_NOTICE);
    }
    /**
