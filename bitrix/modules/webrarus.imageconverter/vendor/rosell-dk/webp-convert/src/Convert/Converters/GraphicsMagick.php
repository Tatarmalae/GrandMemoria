...
class GraphicsMagick extends AbstractConverter
{
    ...
    {
        return OptionFactory::createOptions([self::niceOption()]);
    }
        ...
        if (!\is_null($options['preset'])) {
            if ($options['preset'] != 'none') {
                ...
                switch ($imageHint) {
                    ...
                    case 'text':
                        $imageHint = 'graph';
                        $this->logLn('Note: the preset was mapped to "graph" because graphicsmagick does not support ' . '"drawing", "icon" and "text", but grouped these into one option: "graph".');
                }
