...
namespace Rarus\Isolated\WebPConvert\Helpers;

use Rarus\Isolated\WebPConvert\Exceptions\InvalidInputException;
use Rarus\Isolated\WebPConvert\Exceptions\InvalidInput\TargetNotFoundException;
/**
...
class PathChecker
{
    ...
    public static function checkDestinationPath($destination)
    {
        ...
        if (!\preg_match('#\\.webp$#i', $destination)) {
            ...
            throw new InvalidInputException('Destination file must end with ".webp". ' . 'If you deliberately want to store the webp files with another extension, you must rename ' . 'the file after successful conversion');
        }
