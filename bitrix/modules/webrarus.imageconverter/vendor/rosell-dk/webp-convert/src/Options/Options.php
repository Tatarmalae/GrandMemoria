...
use Rarus\Isolated\WebPConvert\Options\Exceptions\OptionNotFoundException;
/**
...
class Options
{
    ...
    public function setOption($id, $value)
    {
        if (!isset($this->options[$id])) {
            throw new OptionNotFoundException('Could not set option. There is no option called "' . $id . '" in the collection.');
        }
    ...
    {
        if (!isset($this->options[$id])) {
            throw new OptionNotFoundException('There is no option called "' . $id . '" in the collection.');
        }
