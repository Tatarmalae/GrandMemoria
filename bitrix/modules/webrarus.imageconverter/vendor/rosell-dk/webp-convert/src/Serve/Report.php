...
use Rarus\Isolated\WebPConvert\Loggers\EchoLogger;
...
<html>
    ...
    <body>
        <table>
            <tr><td><i>source:</i></td><td><?php 
        echo \htmlentities($source);
        ?></td></tr>
            <tr><td><i>destination:</i></td><td><?php 
        echo \htmlentities($destination);
        ?><td></tr>
        </table>
        <br>
        <?php 
        try {
            ...
            $options['log-call-arguments'] = \true;
