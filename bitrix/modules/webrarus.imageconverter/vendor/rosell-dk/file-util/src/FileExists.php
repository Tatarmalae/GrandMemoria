...
namespace Rarus\Isolated\FileUtil;

use Rarus\Isolated\FileUtil\FileExistsUsingExec;
/**
...
class FileExists
{
    ...
    public static function fileExists($path)
    {
        ...
        \set_error_handler(array('Rarus\\Isolated\\FileUtil\\FileExists', "warningHandler"), \E_WARNING | \E_USER_WARNING | \E_NOTICE | \E_USER_NOTICE);
