...
namespace Rarus\Isolated\Psr\Log\Test;

use Rarus\Isolated\Psr\Log\LoggerInterface;
use Rarus\Isolated\Psr\Log\LogLevel;
use Rarus\Isolated\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Rarus\\Isolated\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Rarus\\Isolated\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Rarus\\Isolated\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
