 ...
 */
namespace Rarus\Isolated\Composer;

use Rarus\Isolated\Composer\Autoload\ClassLoader;
use Rarus\Isolated\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Rarus\\Isolated\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
